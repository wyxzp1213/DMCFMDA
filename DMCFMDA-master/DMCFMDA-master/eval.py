...
def result(args):
    data = get_data(args)
    args.microbe = data['microbe']
    args.disease_number = data['disease_number']
    data_processing(data,args)
    score = train(data,args)
...
parser.add_argument('--fm', type=int, default=64, help='length of microbe feature')
...
parser.add_argument('--gt_layer', type=int, default=2, help='graph transformer layer')
